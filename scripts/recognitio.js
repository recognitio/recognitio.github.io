...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "recognitio.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "recognitio.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'recognitio'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'recognitio':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        ...
        initialize: function( instance ) {
            ...
            Module.exports.generate_question = function generate_question(ontology_source) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.generate_question(Module.STDWEB_PRIVATE.prepare_any_arg(ontology_source)));
}
;
                Module.exports.challenge = function challenge(question) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.challenge(Module.STDWEB_PRIVATE.prepare_any_arg(question)));
}
;
                Module.exports.response = function response(question) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.response(Module.STDWEB_PRIVATE.prepare_any_arg(question)));
}
;
                Module.exports.load_ontology = function load_ontology(ontology_source) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.load_ontology(Module.STDWEB_PRIVATE.prepare_any_arg(ontology_source)));
}
;
            __web_on_grow();
